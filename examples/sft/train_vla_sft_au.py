...
"""Entry script for openpi_au SFT with EMA + faithful augmentation."""
...
@hydra.main(
    version_base="1.1", config_path="config", config_name="libero_sft_openpi_pi05_au"
)
def main(cfg) -> None:
    ...
    if cfg.actor.training_backend in ("fsdp", "fsdp2"):
        actor_group = FSDPVlaSftWorkerAu.create_group(cfg).launch(
