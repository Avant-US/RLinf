...
AUPI_DIR="${AUPI_DIR:-/mnt/r/share/zwy/Project/pi/openpi}"
...
TAR="/tmp/RLinf-code-demo5.tar.gz"
AUPI_TAR="/tmp/openpi-code-demo5.tar.gz"
...
gcloud storage cp "${SCRIPT_DIR}/pushdoor_bootstrap.sh" "${GCS_ROOT}/demo5/pushdoor_bootstrap.sh"
