...
export R1PRO_DATA=/mnt/r/DATA/FW/data_0530/lerobot_open_merged_v21 #默认是25版R1 Pro采集的数据
...
echo "[env] REPO_PATH=${REPO_PATH}"
echo "[env] R1PRO_DATA=${R1PRO_DATA}"
echo "[env] RUN_LOGROOT=${RUN_LOGROOT}"
...
nohup bash examples/sft/run_fastwam_sft.sh r126_vid_stat_aug_stro1 \
