...
export R1PRO_DATA=/mnt/r/share/kaixin/data_0530/lerobot_open_merged_v21

BTLOG_ROOT="/mnt/r/CKPT/VLA/FW/RUN"
PRJID=R1PR
PRJ_ROOT="${BTLOG_ROOT}/${PRJID}"
RUNID=R1
RUN_ROOT="${PRJ_ROOT}/${RUNID}"
...
nohup bash examples/sft/run_fastwam_sft.sh r1_pro_sft_fastwam \
  ...
  runner.logger.log_path=${PRJ_ROOT} \
  > ${LOG_NAME} 2>&1 &
