...
from franky_ext.tasks.cube_place import FrankyCubePlaceEnv
...
def create_franky_cube_place_env(
    override_cfg: dict[str, Any],
    worker_info: Any,
    hardware_info: Any,
    env_idx: int,
...
register(
    ...
    entry_point="franky_ext.tasks.register:create_franky_cube_place_env",
)
